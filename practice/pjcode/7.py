...
[312.08773866989924, 159.03564546156628]], "6558'", 0.38875285736461235), ([[95.18251969601066, 77.09743317289913],
 [302.18709853788476,58.27151305392426], [306.8174803039893, 203.90256682710088], [98.81290146211524, 223.72848694607575]],
  '332마', 0.42204072737788406), ([[343.5857864376269, 170.5857864376269], [376.5504699710346, 164.73665409767554], 
...
# result = [([[5, 5], [159, 5], [159, 41], [5, 41]], '65400', 0.6971155729892677), ([[95.18251969601066, 77.09743317289913],
#  [302.18709853788476,58.27151305392426], [306.8174803039893, 203.90256682710088], [98.81290146211524, 223.72848694607575]],
#   '14하', 0.42204072737788406)]
# result = [([[5, 5], [159, 5], [159, 41], [5, 41]], '65가400', 0.6971155729892677), ([[95.18251969601066, 77.09743317289913],
#  [302.18709853788476,58.27151305392426], [306.8174803039893, 203.90256682710088], [98.81290146211524, 223.72848694607575]],
#   '14하', 0.42204072737788406)]
import re
...
print('수정전:',first_num,'/', second_num) 
    ...
    for j in i[1] :
        ...
        for str in plate :
            if j == str :
                ...
                elif first_num == '' and second_num == '' and '가'<=j<='힣' and str_cnt == 0 : 
                    str_cnt += 1
                    first_num=result_list[:result_list.index(j)+1]
                    second_num=result_list[result_list.index(j)+1:] 
...
print('수정후:',first_num,'/', second_num) 
